defmodule ReadoutWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ReadoutWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ReadoutWeb.Gettext, "errors", msg, opts)
    end
  end
