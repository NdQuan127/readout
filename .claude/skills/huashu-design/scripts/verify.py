#!/usr/bin/env python3
"""
verify.py — Playwright wrapper to verify HTML design outputs

Usage:
    python verify.py path/to/design.html                    # Basic: open + screenshot + capture console errors
    python verify.py design.html --viewports 1920x1080,375x667  # Multi-viewport
    python verify.py deck.html --slides 10                  # Slide deck screenshot page-by-slide (first 10 pages)
...
def main():
    ...
    parser.add_argument("--slides", type=int, default=0,
                        help="Slide deck mode: capture the first N slides (requires HTML to support page turning with ArrowRight)")
    parser.add_argument("--output", default=None,
                        help="Output directory (default is screenshots/ in the HTML directory)")
    parser.add_argument("--show", action="store_true",
                        help="Non-headless, open real browser window")
    parser.add_argument("--wait", type=int, default=2000,
                        help="Wait time in milliseconds after opening page (default 2000)")
