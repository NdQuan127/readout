#!/usr/bin/env node
/**
 * tts-doubao.mjs · Doubao Voice TTS (Volcano Engine openspeech)
 *
 * Usage:
 ...
 *
 * env (automatically loaded from skill root .env, can be overridden by process.env):
...
tts-doubao.mjs · Doubao Voice TTS
  ...
  --text-file <path>    Read text from file (choose either --text or --text-file)
  --out <path>          Output MP3 path (required)
  --speed <float>       Speech rate ratio, default 1.0 (0.5-2.0)
  --voice <voice_id>    Override voice ID specified in .env
