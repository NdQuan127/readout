 ...
 *
 * Used to display 2+ static design variations for side-by-side comparison.
 * Each variation has a label and can be hovered to zoom.
 *
 * Usage:
 *   <DesignCanvas
 ...
 *   </DesignCanvas>
 *
 * Used with React + Babel. Place in an appropriate script so window.DesignCanvas and window.Variation are available.
 */
