 ...
 *
 * Exports (exposed on window.Animations):
 * - Stage: The main animation container, providing time + playback controls
 * - Sprite: Time segment, active within start/end, providing local progress
...
(function() {
  ...
  const Easing = {
    ...
    // Fast start + slow deceleration, giving digital elements a sense of physical weight
    expoOut: t => t === 1 ? 1 : 1 - Math.pow(2, -10 * t),
    // overshoot: bouncy toggle/button pop-up (cubic-bezier(0.34, 1.56, 0.64, 1))
    overshoot: t => {
